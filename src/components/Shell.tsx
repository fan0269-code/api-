import { BarChart3, BookOpen, CreditCard, KeyRound, ListChecks, LogOut, Network, PanelsTopLeft, RadioTower } from 'lucide-react';
...
const navItems = [
  ...
  { to: '/requests', label: '调用日志', icon: ListChecks },
